        ...
        <CardContent>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="you@example.com" className="rounded-xl h-11" disabled={regionBlocked} />
            </div>
            <div className="space-y-2">
              ...
              <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="••••••••" className="rounded-xl h-11" disabled={regionBlocked} />
            </div>
            {error && (
              <div className="flex items-center gap-2 text-destructive text-body-sm">
                <AlertCircle className="w-4 h-4" />
            ...
            <Button type="submit" className="w-full h-11 rounded-xl" disabled={loading || regionBlocked}>
          ...
          <Button variant="outline" className="w-full h-11 rounded-xl" onClick={handleGoogleLogin} disabled={googleLoading || regionBlocked}>
