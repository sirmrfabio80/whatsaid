  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:py-16 max-w-4xl">
      <div className="text-center mb-10">
        <h1 className="font-heading text-3xl sm:text-4xl font-bold mb-2">Your Credits</h1>
        ...
        {CREDIT_PACKS.map((pack, i) => (
          ...
          >
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full" variant={i === 1 ? "default" : "outline"} onClick={() => handleBuyPack(i)}>
