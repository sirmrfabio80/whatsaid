    ...
    <div className="flex items-center gap-2 flex-wrap" role="group" aria-label="Speaker labels">
      ...
      {onAddSpeaker && (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-dashed border-border/60 bg-transparent px-3 py-1.5 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors min-h-[36px] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
...
function SpeakerChip({
  ...
  if (editing) {
    return (
      <div className="inline-flex items-center gap-1 rounded-full border border-primary/40 bg-background px-2 py-1 shadow-sm ring-1 ring-primary/10">
  ...
  return (
    <div className="inline-flex items-center gap-0">
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-full border border-border/60 bg-muted/50 px-3 py-1.5 text-xs font-medium hover:bg-muted transition-colors min-h-[36px] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${enableDrag ? "cursor-grab active:cursor-grabbing" : ""}`}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="inline-flex items-center justify-center w-7 h-7 ml-0.5 rounded-full text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      {isDeletable && (
        <button
          ...
          className="inline-flex items-center justify-center w-7 h-7 ml-0.5 rounded-full text-muted-foreground/50 hover:text-destructive hover:bg-destructive/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
